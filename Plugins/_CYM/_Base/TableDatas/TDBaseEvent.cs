...
namespace CYM
{
    ...
    public class TDBaseEventData : TDBaseData
    {
        #region Config
        // 奖励
        public BaseEventOption Option1 { get; set; }
        public BaseEventOption Option2 { get; set; }
        public BaseEventOption Option3 { get; set; }
        public BaseEventOption Option4 { get; set; }
        ...
        public List<BaseEventOption> Options { get; private set; } = new List<BaseEventOption>();
        #endregion

        #region life
        public virtual void DoReward(List<BaseReward> datas) => throw new Exception("此函数必须被实现");
        ...
        #region get
        public string GetOpName(BaseEventOption option)
        {
