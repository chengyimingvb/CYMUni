...
/// Reorderable list.
/// </summary>
public class EditorReorderableList<T> where T : class
{
	...
	public Action<EditorReorderableList<T>, T> listItemDrawCallback;
	// Callback used to draw empty list items (while dragging over)
	public Action<EditorReorderableList<T>> emptyListItemDrawCallback;
	// Callback used to determine a list item's name for display
	// using the default list draw callback and for dragging
	public Func<EditorReorderableList<T>, T, string> listItemNameCallback;
	// Callback used to set the GUIContent used for list items
	// using the default list draw callback
	public Func<EditorReorderableList<T>, T, GUIContent> listItemContentCallback;
	// Callback used to get the unity object references that should
	// be used for lists based on non-unity objects.
	public Func<EditorReorderableList<T>, T[], UnityEngine.Object[]> objectReferencesCallback;
	// Callback used to remove list items from the list
	public Action<EditorReorderableList<T>, int> listItemRemoveCallback;
	
	// Action sent by the default list item draw callback
	public event Action<EditorReorderableList<T>, T> listItemClickEvent;
	...
	// Constructor
	public EditorReorderableList(List<T> list = null, bool allowDuplicates = false)
	{
		this.List = list;
