...
namespace CYM
{
    public class BaseAnim<TUnit, TState> : StateMachineBehaviour where TUnit : BaseUnit where TState : Enum
    {
        ...
        override public void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
        {
            ...
            {
                (Self.AnimMgr as IBaseMecAnimMgr).ChangeState(Enum<TState>.Int(State), Index);
            }
        }
        ...
        //protected virtual BaseMecAnimMgr<TUnit, TState> AnimMgr => throw new Exception("此函数必须被实现");
    }
}
