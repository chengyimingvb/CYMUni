...
namespace CYM
{
    ...
    public class BasePerform : BaseCoreMono, ITriggerObject
    {
        #region Inspector
        ...
        protected EffectFlicker effectFlicker;
        protected EffectFollow effectFollow;
        ...
        public virtual void OnClose()
        {
            ...
            {
                effectFlicker.StartEffect(0.0f, CloseTime);
            }
            else if (DispearType == PerformDispearType.Scale)
            {
