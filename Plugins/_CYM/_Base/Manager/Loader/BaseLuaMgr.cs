...
namespace CYM
{
    public class BaseLuaMgr : BaseGFlowMgr, ILoader
    {
        ...
        /// lua管理器列表类
        /// </summary>
        public static List<ITDLuaMgr> LuaMgrList { get; private set; } = new List<ITDLuaMgr>();
        public static Dictionary<Type, ITDLuaMgr> LuaMgrDic { get; private set; } = new Dictionary<Type, ITDLuaMgr>();
        public static Dictionary<string, ITDLuaMgr> LuaMgrDicStr { get; private set; } = new Dictionary<string, ITDLuaMgr>();
        ...
        #region set
        public static ITDLuaMgr GetTDLuaMgr(Type luaKey)
        {
            if (LuaMgrDic.ContainsKey(luaKey))
                return LuaMgrDic[luaKey];
            else
            {
                return null;
            }
