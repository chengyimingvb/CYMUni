...
namespace CYM
{
    ...
    #region reward cost
    public class BaseRewardCost<TUnit, T> : BaseReward where TUnit : BaseUnit where T : Enum
    {
        #region config
    ...
    #region reward buff
    public class BaseRewardSimple<TUnit, TData, TType> : BaseReward where TUnit : BaseUnit where TData : TDBaseBuffData<TType>, new() where TType : Enum
    {
        #region config
