...
namespace CYM
{
    public class BaseSteamSDKMgr : BasePlatSDKMgr
    {
        ...
        public override bool IsLegimit
        {
            get
            {
                if (BuildConfig.Ins.IsDevBuild)return true;
        ...
        public override string GetCurLanguageStr()=> SteamApps.GameLanguage;
        #endregion
        ...
        public override void RefreshLeaderBoard(string id = "")
        {
            ...
            BaseGlobal.CommonCoroutineter.Run(_UpdateFetchLeaderBoard());
        }
