...
namespace CYM
{
    ...
    public class BaseLogicTurnMgr<T> : BaseGFlowMgr, IBaseLogicTurnMgr where T : BaseUnit
    {
        #region Callback val
        /// <summary>
        /// T:当前执行操作的单位
        ...
        #region prop
        protected BaseUnit Player => BaseGlobal.ScreenMgr.BaseLocalPlayer;
        //处于当前回合的单位
        ...
        //回合内必须处理的数据
        public List<BaseMustProcess> MustProcessDatas { get; protected set; } = new List<BaseMustProcess>();
        ...
        protected virtual List<T> CalcAllUnits() => null;
        ...
        {
            base.OnEnable();
            ScreenMgr.Callback_OnSetPlayerBase += OnSetPlayerBase;
        }
        ...
        //添加必须处理的事务
        public void AddMustProcess(BaseMustProcess data)
        {
        ...
        protected virtual List<BaseUnit> GetMoveableUnits(T unit) => throw new NotImplementedException();
        #endregion
        ...
        private void OnSetPlayerBase(BaseUnit arg1, BaseUnit arg2)
        {
            CurTurnIndex = 0;
            StartTurn(true);
        }
