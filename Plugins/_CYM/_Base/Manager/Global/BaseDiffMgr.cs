...
namespace CYM
{
    ...
    public class BaseDiffMgr<T> : BaseGFlowMgr, IBaseDifficultMgr, IDBConverMgr<T> 
        where T : DBBaseGameDiff, new()
    {
        ...
        public DBBaseGameDiff GetBaseSettings()
        {
            return Setting;
        }
        #endregion
