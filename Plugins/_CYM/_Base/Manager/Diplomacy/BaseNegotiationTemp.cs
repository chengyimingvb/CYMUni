...
namespace CYM
{
    public class BaseDipPoint<TUnit, TWar> where TUnit : BaseUnit where TWar : BaseWarfareData<TUnit>
    {
        ...
        {
            return SetStr() + ": " + UIUtil.ColSign(Score);
        }
        #endregion
    ...
    public class BaseNegotiationTemp<TUnit, TWarData> where TUnit : BaseUnit where TWarData : BaseWarfareData<TUnit>
    {
        ...
        public BaseNegotiationTemp<TUnit, TWarData> SetParam(TUnit self, TUnit target, TWarData warData, List<TDBaseArticleData> selfArticle, List<TDBaseArticleData> targetArticle)
        {
