...
namespace CYM.UI
{
    public class BaseUIMgr : BaseGFlowMgr, IUIDirty
    {
        ...
        HashSet<UControl> IgnoreBlockClick { get;  set; } = new HashSet<UControl>();
        HashSet<UControl> IgnoreBlockClickOnce { get; set; } = new HashSet<UControl>();
        ...
        public bool IsBlockClick
        {
            get
            {
                return isBlockClickFlag;
            }
        }
        bool isBlockClickFlag = false;
        #endregion
        ...
        {
            if (IgnoreBlockClickOnce.Contains(control))
                return;
            IgnoreBlockClickOnce.Add(control);
        }
        public void RemIgnoreBlockClickOnce(UControl control)
        {
            IgnoreBlockClickOnce.Remove(control);
        }
        public bool IsIgnoreBlockClickOnce(UControl control)
        {
            return IgnoreBlockClickOnce.Contains(control);
        }
