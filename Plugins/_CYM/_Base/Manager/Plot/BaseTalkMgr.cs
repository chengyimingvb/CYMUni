...
namespace CYM
{
    public class BaseTalkMgr<TData> : BaseGFlowMgr, IBaseTalkMgr where TData : TDBaseTalkData, new()
    {
        #region Callback val
        /// <summary>
        /// 开始一段对话
        /// </summary>
        public Callback<TData, TDBaseTalkFragment> Callback_OnStart { get; set; }
        /// <summary>
        /// 下一段对话
        /// </summary>
        public Callback<TData, TDBaseTalkFragment, int> Callback_OnNext { get; set; }
        /// <summary>
        /// 显示对话
        /// </summary>
        public Callback<TData, TDBaseTalkFragment, int> Callback_OnTalk { get; set; }
        /// <summary>
        /// 结束一段对话
        /// </summary>
        ...
        /// </summary>
        /// <param name="id"></param>
        public TDBaseTalkFragment StartOption(string id)
        {
        ...
        /// 下一段对话
        /// </summary>
        public virtual TDBaseTalkFragment Next()
        {
            if (IsLockNextTalk)
                return null;
            if (!IsStartTalk)
        ...
        #region get
        public TDBaseTalkFragment CurTalkFragment()
        {
            if (!IsHave())
                return new TDBaseTalkFragment();
