...
namespace CYM.UI
{
    public class UHUDItem : UPresenter<UPresenterData>
    {
        ...
        [FoldoutGroup("Curve"), SerializeField, HideIf("Inspector_HideDestroyWhenTimeOut")]
        public bool CurveChange = true;
        [FoldoutGroup("Curve"), SerializeField, HideIf("Inspector_HideDestroyWhenTimeOut")]
        public bool ShowEffect = false;
        [FoldoutGroup("Curve"), SerializeField,HideIf("Inspector_HideCurve")]
        public Color Color;
        [FoldoutGroup("Curve"),HideIf("Inspector_HideCurve")]
        ...
        protected float CurLifePercent => CurTime / LifeTime;
        #endregion

        #region is
        public bool IsLifeOver => CurTime >= LifeTime;
