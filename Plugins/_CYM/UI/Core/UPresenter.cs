...
namespace CYM.UI
{
    public class UPresenterData
    {
        ...
        //触发
        public Callback<UControl> OnEnter;
        public Callback<UControl> OnExit;
        public Callback<UControl, PointerEventData> OnClick;
        public Callback<UControl, PointerEventData> OnTempClick; //用于替换原生的Click事件
        public Callback<UControl, PointerEventData> OnPlotDelayClick;
    ...
    public class UPresenter<TData> : UControl, 
        IPointerEnterHandler, 
        IPointerExitHandler, 
        IPointerClickHandler, 
        IPointerDownHandler, 
        IPointerUpHandler
        where TData : UPresenterData, new()
    {
        #region Inspector 
        ...
        {
            if (UIMgr!=null && UIMgr.IsInIgnoreBlockClick(this))
                return true;
        ...
        public virtual void OnPointerEnter(PointerEventData eventData)
        {
            ...
            if (Data != null)
            {
                ...
                //现实提示
                if (Data.OnEnter != null) Data.OnEnter.Invoke(this);
                else if (!Data.TipKey.IsInv()) BaseTooltipView.Default?.Show(Data.TipKey);
            }
        ...
        public virtual void OnPointerExit(PointerEventData eventData)
        {
            ...
            BaseTooltipView.CurShow?.Show(false);
        ...
        public virtual void OnPointerClick(PointerEventData eventData)
        {
            ...
            if (UIMgr!=null &&
                ...
                PlotMgr.IsInPlot())
            {
                if(UIMgr.IsIgnoreBlockClickOnce(this))
                    BaseGuideView.Default?.CloseWhenMaskOnce();
                Data?.OnPlotClick?.Invoke(this,eventData);
                Util.Invoke(()=> {
                    Data?.OnPlotDelayClick?.Invoke(this, eventData);
                    Data.OnPlotDelayClick = null;
                },0.05f);
            }
            UIMgr?.RemIgnoreBlockClickOnce(this);
            PlayClickAudio();
