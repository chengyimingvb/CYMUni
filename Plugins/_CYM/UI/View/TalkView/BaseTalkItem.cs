...
namespace CYM.UI
{
    public class BaseTalkItemData : UPresenterData
    {
    ...
    public class BaseTalkItem : UPresenter<BaseTalkItemData>
    {
        #region inspector
        ...
        public void Show(TDBaseTalkData talkData, TDBaseTalkFragment talkFragment)
        {
            ...
            if (Icon != null) Icon.Icon.overrideSprite = GetIcon(talkData, talkFragment);
        ...
        protected virtual Sprite GetIcon(TDBaseTalkData talkData, TDBaseTalkFragment talkFragment)
        {
            return talkFragment.GetIcon();
        }
        protected virtual string GetName(TDBaseTalkData talkData, TDBaseTalkFragment talkFragment)
        {
            return talkFragment.GetName();
        }
        protected virtual string GetAudio(TDBaseTalkData talkData, TDBaseTalkFragment talkFragment)
        {
