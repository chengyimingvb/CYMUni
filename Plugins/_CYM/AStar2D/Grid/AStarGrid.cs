...
namespace CYM.AStar2D
{
    ...
    [RequireComponent(typeof(WeightPainter2D))]
    public class AStarGrid : MonoBehaviour
    {
        ...
        private Node[,] Nodes;
        private WeightPainter2D painter = null;
        ...
        public void Start()
        {
            painter = gameObject.GetComponent<WeightPainter2D>();// FindObjectOfType<WeightPainter2D>();
        }
